...
def run_all_seed_consistency_heatmaps(force_recreate=False):
    print(f"Running seed consistency heatmaps for {len(ABLATIONS_TO_PLOT)} sequential ablation(s).\n")
...
if __name__ == "__main__":
    ...
    run_all_seed_consistency_heatmaps(force_recreate=arguments.force_recreate)